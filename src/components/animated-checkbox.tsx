    ...
    const animatedBoxProps = useAnimatedProps(
        () => ({
            stroke: interpolateColor(
                // (Easing.bezier(0.16, 1, 0.3, 1).factory)()(progress.value), // does't seem like in the vdo
                Easing.bezierFn(0.16, 1, 0.3, 1)(progress.value), // does't seem like in the vdo
                [0,1],
